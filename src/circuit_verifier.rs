...
//   use crate::parameters::{get_bw6_fr_params, poseidon_params};
//   use crate::sqrt_pst::Polynomial;

//   #[test]
//   fn check_r1cs_proof_bw6() {
//     let params = crate::parameters::get_bw6_fr_params();
//     check_sqrt_poly_commit::<ark_bw6_761::BW6_761>(params, 5);
//   }

//   fn check_sqrt_poly_commit<P>(params: PoseidonConfig<P::ScalarField>, num_vars: u32)
//   where
//     P: Pairing,
//   {
//     let mut rng = ark_std::test_rng();
//     let len = 2_usize.pow(num_vars);
//     let Z: Vec<P::ScalarField> = (0..len)
//       .into_iter()
//       .map(|_| P::ScalarField::rand(&mut rng))
//       .collect();
//     let r: Vec<P::ScalarField> = (0..num_vars)
//       .into_iter()
//       .map(|_| P::ScalarField::rand(&mut rng))
//       .collect();

//     let gens = MultilinearPC::<P>::setup(3, &mut rng);
//     let (ck, vk) = MultilinearPC::<P>::trim(&gens, 3);
...
//     //let params = poseidon_params();
//     let mut verifier_transcript = PoseidonTranscript::new(&get_bw6_fr_params());

...
// impl<E> R1CSVerificationCircuit2<E>
// where
//   E: Pairing,
// {
...
//       sc_phase1: crate::prova4::SumCheckVerificationCircuit {
//         polys: uni_polys_round1,
//       },
//       sc_phase2: crate::prova4::SumCheckVerificationCircuit {
...
//     };
//     // now all the R1CSVerificationCiruit are based on E::BaseField so we neeed to implement groth on BW6
...
//   gens_gc: R1CSVerificationCircuit2<E>,
// }
...
//     let gens_gc = R1CSVerificationCircuit2::setup(num_cons, num_vars, num_inputs, poseidon);
...
//     // questo non si può toccare perchè si basa su F
...
//     // questa non può essere toccata perchè dipende tutto da F
...
//   use crate::{parameters::{PoseidonConfiguration, get_bls12377_fq_params}, circuit_verifier};
//   #[test]
...
//     let (inst, vars, input) =
//     R1CSInstance::<ark_bls12_377::Fr>::produce_synthetic_r1cs(num_cons, num_vars, num_inputs);

//     // let (inst, vars, input) =
//     //   R1CSInstance::<P::ScalarField>::produce_synthetic_r1cs(num_cons, num_vars, num_inputs);

//     let params2 = get_bls12377_fq_params();
//     let gens = R1CSGens::<ark_bls12_377::Bls12_377>::setup(b"test-m", num_cons, num_vars, num_inputs, params2.clone());

//     let (pk, vk) = Groth16::<ark_bw6_761::BW6_761>::circuit_specific_setup(gens.gens_gc.clone(), &mut rng).unwrap();

//     // //let params = poseidon_params();
//     // // let mut random_tape = RandomTape::new(b"proof");

//     let mut prover_transcript = PoseidonTranscript::new(&params2.clone());
//     let c = prover_transcript.challenge_scalar::<ark_bls12_377::Fr>(b"");

//     // DA FARE prover_transcript.new_from_state(&c);
